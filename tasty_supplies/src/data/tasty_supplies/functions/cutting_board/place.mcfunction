...
$execute align zyx positioned ~0.5 ~0.5 ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"armor_stand", count: 2750014, components:{custom_model_data: 2750014, custom_data:{"tags":["cutting_board", "cutting_board_display"]}}}, Rotation: $(Rotation)}
