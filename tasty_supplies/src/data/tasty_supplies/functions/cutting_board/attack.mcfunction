...
execute positioned ~ ~0.078125 ~-0.125 as @e[type=item_display, distance=..1, limit=1, sort=nearest] if data entity @s item.components."minecraft:custom_data"{tags:["cutting_board_display"]} run return run function tasty_supplies:cutting_board/break
# Else drop the item
