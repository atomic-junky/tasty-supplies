...
$execute align zyx positioned ~0.5 ~ ~0.5 run summon minecraft:item_display ~ ~ ~ {item:{id:"armor_stand", count: 2750014, components:{custom_model_data: {"strings": ["tasty_supplies/cutting_board"]}, custom_data:{"tags":["cutting_board", "cutting_board_display"]}}}, Rotation: $(Rotation), transformation:{left_rotation:{angle:0f,axis:[0f,1f,0f]},right_rotation:{angle:0f,axis:[0f,1f,0f]},translation:[0f,0.5f,0f],scale:[1f,1f,1f]}}
